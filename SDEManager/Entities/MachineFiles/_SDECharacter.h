...
// Make changes to SDECharacter.h instead.

#import <CoreData/CoreData.h>


extern const struct SDECharacterAttributes {
	...
	__unsafe_unretained NSString *isShapeshifted;
...
} SDECharacterAttributes;

extern const struct SDECharacterRelationships {
...
} SDECharacterRelationships;

extern const struct SDECharacterFetchedProperties {
} SDECharacterFetchedProperties;
...
@interface SDECharacterID : NSManagedObjectID {}
@end

@interface _SDECharacter : NSManagedObject {}
+ (id)insertInManagedObjectContext:(NSManagedObjectContext*)moc_;
+ (NSString*)entityName;
+ (NSEntityDescription*)entityInManagedObjectContext:(NSManagedObjectContext*)moc_;
- (SDECharacterID*)objectID;
...
@property (nonatomic, strong) NSNumber* isShapeshifted;



@property BOOL isShapeshiftedValue;
- (BOOL)isShapeshiftedValue;
- (void)setIsShapeshiftedValue:(BOOL)value_;

//- (BOOL)validateIsShapeshifted:(id*)value_ error:(NSError**)error_;
...
@property (nonatomic, strong) SDECharacter *shapeshift;
...
@interface _SDECharacter (CoreDataGeneratedAccessors)
...
- (void)addStatusEffectsObject:(SDEAttribute*)value_;
- (void)removeStatusEffectsObject:(SDEAttribute*)value_;

@end

@interface _SDECharacter (CoreDataGeneratedPrimitiveAccessors)
...
- (NSNumber*)primitiveIsShapeshifted;
- (void)setPrimitiveIsShapeshifted:(NSNumber*)value;

- (BOOL)primitiveIsShapeshiftedValue;
- (void)setPrimitiveIsShapeshiftedValue:(BOOL)value_;
...
- (SDECharacter*)primitiveShapeshift;
- (void)setPrimitiveShapeshift:(SDECharacter*)value;
